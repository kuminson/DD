...
# UEFI systems need an EFI System Partition. The original script used the
# one-partition "all files" recipe, which created vda1 as Linux filesystem
# instead of an EFI partition and caused grub-installer to fail with
